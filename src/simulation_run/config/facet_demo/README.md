...
| `demo_facet_physics.json` | `Wind` and `Wake` agents, 5 `Bluerov2_heavy_current` under the GNC pipeline, 5 `Wamv`, 5 `X500_inspection`, and the two PX4 `X500`s from `wind_wake_examples/wake_crossing_demo.json` running `px4_offboard_patrol`. |
