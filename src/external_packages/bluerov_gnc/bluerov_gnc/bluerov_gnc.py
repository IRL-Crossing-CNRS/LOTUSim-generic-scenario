"""BlueROV2 Heavy agent for the closed-loop PID + ocean-current runs.
...
class Bluerov2HeavyPid(PhysicalEntity):
    ...
    # first Gazebo step already carries every key xdyn expects, before the PID
    # task has published anything (props 6 and 7 are not in the model).
    INITIAL_COMMANDS = {
